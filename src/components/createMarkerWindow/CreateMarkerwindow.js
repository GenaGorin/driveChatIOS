...
export default CreateMarkerwindow = ({
  chabgeFeedbcakModal,
  createMarkerAndStopMode,
  stopMode,
  banInfo,
}) => {
    ...
    return (
      <View style={styles.header}>
        ...
        <TouchableOpacity
          activeOpacity={0.5}
          onPress={goContacts}
          style={[styles.buttons, {backgroundColor: '#50ACFF'}]}>
          <Text
            style={{
              fontSize: 18,
              color: '#FFFFFF',
  ...
  return (
    <View style={styles.windowWrapper}>
      <Animated.View
        ...
        <TouchableOpacity
          onPress={showActiveImg}
          style={[styles.buttons, {backgroundColor: '#FF4E4E'}]}>
          <View style={{flexDirection: 'row'}}>
            <Image
              source={require('../../images/controls/starFull.png')}
        ...
        <TouchableOpacity
          onPress={showPassiveImg}
          style={[styles.buttons, {backgroundColor: '#50ACFF'}]}>
          <View style={{flexDirection: 'row'}}>
            <Image
              source={require('../../images/controls/starEmpty.png')}
              style={{width: 40, height: 40, marginLeft: 5}}
            />
        ...
        <TouchableOpacity
          onPress={showMessageImg}
          style={[styles.buttons, {backgroundColor: '#ADADAD'}]}>
          <View style={{flexDirection: 'row'}}>
            <Image
              source={require('../../images/controls/message.png')}
              style={{width: 43, height: 40, marginLeft: 5}}
            />
      ...
      {(passiveImages || activeImages || messageImages) && (
        <TouchableOpacity
          ...
          style={[styles.buttons, {backgroundColor: '#AEE80D', marginTop: 70}]}>
          <View style={{flexDirection: 'row'}}>
            <Image
      ...
      <View style={{marginTop: 15}}>
        <TouchableOpacity
          onPress={stopMode}
          style={[styles.buttons, {backgroundColor: '#626262'}]}>
          <View style={{flexDirection: 'row'}}>
            <Image
              source={require('../../images/controls/deny.png')}
              style={{width: 35, height: 35, marginLeft: 5}}
            />
